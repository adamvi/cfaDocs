...
information such as software package versions (primary and auxilary) and the
computer system platform used in data analyses and report generation. This
appendix provides the `R` and system specifications used in the creation of
this report.

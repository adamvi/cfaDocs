...
xaringanExtra::use_logo(
  image_url = "https://raw.githubusercontent.com/CenterForAssessment/NCME_2022_Demonstration/main/Presentations/cfa_assets/img/CFA_Logo.svg", # could be local if copied to `libs`
  width = "86px",
  height = "100px",
